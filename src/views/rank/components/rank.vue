    ...
    <el-row>
        ...
        <el-col :span="16" v-loading="isLoading" element-loading-text="加载中...">
            <el-table :data="rankList" stripe style="width: 100%">
                ...
                <el-table-column prop="name" label="用户" width="115" align="center">
                    <template #default="scope">
                        <el-link :href="`#/user/${scope.row.uid}/`"><span>{{scope.row.name}}</span></el-link>
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="bio" label="个人介绍" align="center">
                    <template #default="scope">
                        <span>{{scope.row.bio==''?'-':scope.row.bio}}</span>
                    </template>
                </el-table-column>
